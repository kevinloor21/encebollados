...
<nav class="navbar container-fluid navbar-expand-lg navbar-light " style="font-family: algeria;background:#0f0f0f">             
    ...
    @guest
            <h1 class="text-white">𝐸𝑛𝑐𝑒𝑏𝑜𝑙𝑙𝑎𝑑𝑜𝑠</h1>
...
@else
  ...
  <div class="collapse navbar-collapse container-fluid" style="margin-left:55%;">
    <div class="navbar-nav container-fluid" >

      <a class="btn btn-dark " href="{{route('usuario')}}">Usuarios</a>
      <a class="btn btn-dark " href="{{route('clientes')}}">Cliente</a>
      <a class="btn btn-dark " href="{{route('comida')}}">Comida</a>
