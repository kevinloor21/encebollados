                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="usu_name" type="text" class="form-control @error('usu_name') is-invalid @enderror" name="usu_name" value="{{ old('usu_name') }}" required autocomplete="name" autofocus>
